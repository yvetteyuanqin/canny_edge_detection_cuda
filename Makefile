...
canny_par: canny_p.o main_p.cc timer.c
	g++ -o canny_par -I/data/apps/cuda/8.0/include -lpthread -L/data/apps/cuda/8.0/lib64 -lcudart -fopenmp -O3 -Wextra -g -lpng -I/data/apps/boost/1.57/include canny_p.o main_p.cc timer.c -I.
