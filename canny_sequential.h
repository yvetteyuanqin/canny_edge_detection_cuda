...
void suppress(boost::gil::gray8_pixel_t **newImage, boost::gil::gray8_pixel_t **mag, int width, int height,
	boost::gil::gray8_pixel_t **deltaX, boost::gil::gray8_pixel_t **deltaY);
void apply_hysteresis(boost::gil::gray8_pixel_t **out_pixels, boost::gil::gray8_pixel_t **in_pixels, unsigned  char t_high, unsigned  char t_low, int width,int height);
void trace_immed_neighbors(boost::gil::gray8_pixel_t **out_pixels, boost::gil::gray8_pixel_t **in_pixels, unsigned i, unsigned j, unsigned  char t_low);
